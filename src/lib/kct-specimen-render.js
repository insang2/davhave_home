...
<head>
  ...
  <title>공학 시편제작 센터 | ASTM D638 고분자 인장 시편 & ASTM C1401 구조 실리콘 시험체 - KCT 한국건설트레이딩</title>
  ...
  <meta name="keywords" content="ASTM D638, ASTM C1401, ASTM D412, ASTM C1135, 인장 시편 제작, 3D프린팅 시편, PLA시편, DIC 변형률분석, 인스트론, 만능재료시험기, 구조용 실리콘 H-Block, KCT">
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: var(--font); color: var(--gray-800); background: var(--gray-50); line-height: 1.65; -webkit-font-smoothing: antialiased; }
    ...
    .spec-hero::before {
      ...
      position: absolute;
      inset: 0;
      background: radial-gradient(circle at 80% 20%, rgba(234,88,12,0.15) 0%, transparent 60%),
    ...
    .hero-title { font-size: 2.6rem; font-weight: 900; line-height: 1.2; letter-spacing: -0.03em; margin-bottom: 1.2rem; }
    .hero-title span { color: #F97316; }
    .hero-desc { font-size: 1.12rem; color: #CBD5E1; max-width: 820px; line-height: 1.7; margin-bottom: 2rem; font-weight: 400; }
    ...
    .btn-hero-primary { background: linear-gradient(135deg, #EA580C, #C2410C); color: #fff; font-weight: 800; padding: 0.9rem 1.8rem; border-radius: 10px; font-size: 1rem; box-shadow: 0 10px 25px rgba(234,88,12,0.4); display: inline-flex; align-items: center; gap: 0.5rem; transition: transform 0.2s; }
    .btn-hero-primary:hover { transform: translateY(-2px); color: #fff; }
    .btn-hero-secondary { background: rgba(255,255,255,0.12); border: 1px solid rgba(255,255,255,0.25); color: #fff; font-weight: 700; padding: 0.9rem 1.6rem; border-radius: 10px; font-size: 0.95rem; display: inline-flex; align-items: center; gap: 0.5rem; transition: all 0.2s; backdrop-filter: blur(8px); }
    ...
    .section-title { font-size: 2.1rem; font-weight: 900; color: var(--dark); letter-spacing: -0.02em; margin-bottom: 0.8rem; }
    .section-subtitle { font-size: 1.05rem; color: var(--gray-600); line-height: 1.65; }

    /* Card Grid */
    .spec-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 1.8rem; }
    .spec-card {
    ...
    .spec-type-tag { font-family: var(--mono); font-size: 0.8rem; font-weight: 800; color: var(--primary); background: var(--gray-100); padding: 0.25rem 0.6rem; border-radius: 4px; }
    .spec-title { font-size: 1.25rem; font-weight: 800; color: var(--dark); margin-bottom: 0.35rem; }
    .spec-subtitle { font-size: 0.85rem; color: var(--gray-600); margin-bottom: 1rem; }
    ...
    .metric-val { font-family: var(--mono); font-size: 0.95rem; font-weight: 800; color: var(--dark); }
    .metric-val.accent { color: var(--accent); }

    .spec-dim-table { width: 100%; border-collapse: collapse; font-size: 0.82rem; margin-bottom: 1.2rem; }
    .spec-dim-table th, .spec-dim-table td { padding: 0.4rem 0.5rem; border-bottom: 1px solid var(--gray-200); }
    ...
    .spec-desc { font-size: 0.88rem; color: var(--gray-700); line-height: 1.6; margin-bottom: 1.4rem; flex: 1; }
    .spec-btn-action {
      margin-top: auto;
    ...
    .full-comp-table { width: 100%; border-collapse: collapse; font-size: 0.88rem; text-align: left; min-width: 900px; }
    .full-comp-table th { background: var(--gray-900); color: var(--white); padding: 1rem 1.2rem; font-weight: 700; font-family: var(--mono); font-size: 0.82rem; }
    .full-comp-table td { padding: 1rem 1.2rem; border-bottom: 1px solid var(--gray-200); }
    ...
    .estimator-grid { display: grid; grid-template-columns: 1.2fr 1fr; gap: 2.5rem; align-items: center; }
    ...
    .res-row { display: flex; justify-content: space-between; align-items: center; padding: 0.75rem 0; border-bottom: 1px solid rgba(255,255,255,0.08); }
...
<body>
  ...
  <div class="top-bar">
    <div class="container top-bar-inner">
      <div class="top-bar-info">
        <span><i class="bi bi-shield-check text-primary-light"></i> <strong>시험규격:</strong> ASTM D638 / ASTM C1401 / ASTM D412</span>
        <span><i class="bi bi-cpu text-primary-light"></i> <strong>정밀도:</strong> FDM 0.05mm 레이어 적층</span>
        <span><i class="bi bi-camera text-primary-light"></i> <strong>변형률:</strong> DIC 광학 측정 (Ncorr)</span>
      </div>
  ...
  <div class="spec-hero">
    <div class="container">
      <div class="hero-eyebrow">
        <i class="bi bi-gear-wide-connected"></i> ASTM D638 & ASTM C1401 ENGINEERING SPECIMEN LAB
      </div>
      <h1 class="hero-title">
        고분자 인장 시편 & 구조 실리콘 <span>정밀 시편 제작 센터</span>
      </h1>
      <p class="hero-desc">
        ASTM D638 Type I~V 플라스틱 인장 덤벨 시편부터 ASTM C1401/C1135 구조용 실리콘 H-Block 접착 시험체까지, 
        FDM 정밀 3D 프린팅 조형 기술과 DIC(Digital Image Correlation) 비접촉 광학 변형률 분석을 결합한 원스톱 공학 시편 솔루션을 제공합니다.
      </p>

      <div class="hero-badges">
        <span class="hero-badge"><i class="bi bi-check-circle-fill text-accent"></i> ASTM D638 Type I~V 규격 완벽 준수</span>
        <span class="hero-badge"><i class="bi bi-check-circle-fill text-accent"></i> ASTM C1401 / C1135 H-Block 구조접착</span>
        <span class="hero-badge"><i class="bi bi-check-circle-fill text-accent"></i> DIC 2~4px 고대비 스펙클 패턴 표면 가공</span>
        <span class="hero-badge"><i class="bi bi-check-circle-fill text-accent"></i> ★ Type V 고효율 시편 (제작시간·비용 80% 절감)</span>
        <span class="hero-badge"><i class="bi bi-check-circle-fill text-accent"></i> Instron / Shimadzu UTM 시험 파라미터 매핑</span>
      </div>

      <div class="hero-quick-cta">
        <a href="#estimator" class="btn-hero-primary"><i class="bi bi-calculator"></i> 시편 출력시간 & 견적 계산기</a>
        <a href="#standards-grid" class="btn-hero-secondary"><i class="bi bi-diagram-3"></i> 5대 규격 상세 치수 비교표</a>
      </div>
    </div>
  </div>

  <!-- Section 1: ASTM D638 5 Types -->
  <section id="standards-grid" class="container">
    <div class="section-header">
      <span class="section-tag">// Standard Specimen Geometries</span>
      <h2 class="section-title">ASTM D638 5대 인장 시편 규격 정밀 비교</h2>
      <p class="section-subtitle">
        재료의 형태, 가용 두께, 파단 특성 및 경제성에 따라 최적화된 5가지 덤벨(Dog-bone) 시편 형상을 지원합니다.
      </p>
    </div>
    ...
    <div class="spec-grid">
      ...
      <div class="spec-card">
        <div class="spec-card-head">
          ...
          <span style="font-size:0.75rem; color:var(--primary); font-weight:700;"><i class="bi bi-award-fill"></i> 표준 인장 규격</span>
        </div>
        ...
        <div class="spec-metrics">
          ...
          <div class="metric-item">
            ...
            <span class="metric-val">1시간 18분</span>
          </div>
          <div class="metric-item">
        ...
        <table class="spec-dim-table">
          <tr><th>평행부 폭 (W)</th><td>13.0 mm (±0.5)</td></tr>
          <tr><th>평행부 길이 (L)</th><td>57.0 mm (±0.5)</td></tr>
          <tr><th>전체 폭 / 길이 (WO/LO)</th><td>19.0 / 165.0 mm</td></tr>
          <tr><th>표점거리 (G) / 그립간격 (D)</th><td>50.0 / 115.0 mm</td></tr>
          <tr><th>필렛 반경 (R)</th><td>76.0 mm (±1.0)</td></tr>
        </table>

        <p class="spec-desc">
          가장 널리 쓰이는 표준 덤벨 시편으로 강성 및 반경질 고분자(PLA+, ABS, PC)의 공인 인장 시험에 사용됩니다.
        </p>
      ...
      <div class="spec-card">
        <div class="spec-card-head">
          ...
          <span style="font-size:0.75rem; color:#0284C7; font-weight:700;"><i class="bi bi-shield-slash"></i> 비파단 재료용</span>
        </div>
        <h3 class="spec-title">ASTM D638 Type II</h3>
        <div class="spec-subtitle">협소 평행부 (슬립/그립부 조기파단 방지)</div>
        ...
        <div class="spec-metrics">
          ...
          <div class="metric-item">
            <span class="metric-label">3D 출력 소요시간</span>
            <span class="metric-val">1시간 09분</span>
          </div>
          <div class="metric-item">
            <span class="metric-label">필라멘트 소모량</span>
        ...
        <table class="spec-dim-table">
          <tr><th>평행부 폭 (W)</th><td>6.0 mm (±0.5)</td></tr>
          <tr><th>평행부 길이 (L)</th><td>57.0 mm (±0.5)</td></tr>
          <tr><th>전체 폭 / 길이 (WO/LO)</th><td>19.0 / 183.0 mm</td></tr>
          <tr><th>표점거리 (G) / 그립간격 (D)</th><td>50.0 / 135.0 mm</td></tr>
          <tr><th>필렛 반경 (R)</th><td>76.0 mm (±1.0)</td></tr>
        </table>

        <p class="spec-desc">
          Type I 시편 시험 시 표점 외부에서 파단되거나 그립 슬립이 발생하는 재료에 적합한 긴 그립 구조를 갖습니다.
        </p>
      ...
      <div class="spec-card">
        <div class="spec-card-head">
          ...
          <span style="font-size:0.75rem; color:#7C3AED; font-weight:700;"><i class="bi bi-layers-fill"></i> 후판/구조재용</span>
        </div>
        ...
        <div class="spec-metrics">
          ...
          <div class="metric-item">
            <span class="metric-label">3D 출력 소요시간</span>
            <span class="metric-val">3시간 05분</span>
          </div>
          <div class="metric-item">
            <span class="metric-label">필라멘트 소모량</span>
        ...
        <table class="spec-dim-table">
          <tr><th>평행부 폭 (W)</th><td>19.0 mm (±0.5)</td></tr>
          <tr><th>평행부 길이 (L)</th><td>57.0 mm (±0.5)</td></tr>
          <tr><th>전체 폭 / 길이 (WO/LO)</th><td>29.0 / 246.0 mm</td></tr>
          <tr><th>표점거리 (G) / 그립간격 (D)</th><td>50.0 / 115.0 mm</td></tr>
          <tr><th>필렛 반경 (R)</th><td>76.0 mm (±1.0)</td></tr>
        </table>

        <p class="spec-desc">
          두께 7mm 이상의 두꺼운 엔지니어링 플라스틱 판재, 압출재 및 대형 조형체의 대하중 인장 시험 규격입니다.
        </p>
      ...
      <div class="spec-card">
        <div class="spec-card-head">
          ...
          <span style="font-size:0.75rem; color:#D97706; font-weight:700;"><i class="bi bi-shuffle"></i> 연질/탄성체 비교용</span>
        </div>
        ...
        <table class="spec-dim-table">
          <tr><th>평행부 폭 (W)</th><td>6.0 mm (±0.5)</td></tr>
          <tr><th>평행부 길이 (L)</th><td>33.0 mm (±0.5)</td></tr>
          <tr><th>전체 폭 / 길이 (WO/LO)</th><td>19.0 / 115.0 mm</td></tr>
          <tr><th>표점거리 (G) / 그립간격 (D)</th><td>25.0 / 65.0 mm</td></tr>
          <tr><th>필렛 반경 (R / RO)</th><td>14.0 / 25.0 mm</td></tr>
        </table>

        <p class="spec-desc">
          경질 고분자와 연질 탄성체(TPU)의 직접 비교를 위해 외측 반경(RO 25mm)이 설계된 콤팩트 규격입니다.
        </p>
      ...
      <div class="spec-card highlight">
        <span class="spec-badge-top"><i class="bi bi-star-fill"></i> ★ 논문 검증 최고 효율 시편</span>
        <div class="spec-card-head">
        ...
        <div class="spec-metrics" style="background:rgba(234,88,12,0.06); border-color:rgba(234,88,12,0.2);">
          <div class="metric-item">
            <span class="metric-label">최종 인장강도 (UTS)</span>
            <span class="metric-val accent">42.64 MPa (Type I 근접)</span>
          </div>
          <div class="metric-item">
            <span class="metric-label">3D 출력 소요시간</span>
        ...
        <table class="spec-dim-table">
          <tr><th>평행부 폭 (W)</th><td>3.18 mm (±0.5)</td></tr>
          <tr><th>평행부 길이 (L)</th><td>9.53 mm (±0.5)</td></tr>
          <tr><th>전체 폭 / 길이 (WO/LO)</th><td>9.53 / 63.5 mm</td></tr>
          <tr><th>표점거리 (G) / 그립간격 (D)</th><td>7.62 / 25.4 mm</td></tr>
          <tr><th>필렛 반경 (R)</th><td>12.7 mm (±1.0)</td></tr>
        </table>

        <p class="spec-desc">
          <strong>논문 결론 추천:</strong> Type I 대비 출력 시간 14분(5배 단축), 재료 1.8g(5배 절감)으로 80% 이상 비용을 줄이면서도 42.64 MPa의 정밀 인장강도를 도출하는 최고 가성비 규격입니다.
        </p>
  ...
  <section style="background:var(--white); border-top:1px solid var(--gray-200); border-bottom:1px solid var(--gray-200);">
    <div class="container">
      <div class="section-header">
        <span class="section-tag">// Research Paper Data</span>
        <h2 class="section-title">ASTM D638 시편 규격별 성능 및 생산 효율 비교</h2>
        <p class="section-subtitle">
          터키 압둘라 굴 대학(AGU) 연구진의 공인 실측 데이터(FDM PLA+, eSUN, 100% Infill 기준)를 기반으로 정리된 비교표입니다.
        </p>
      </div>

      <div class="table-container">
        <table class="full-comp-table">
          <thead>
            <tr>
              <th>시편 유형</th>
              <th>평행부 치수 (W × L)</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>5.7 g (1.91 m)</td>
              <td>50 mm/min</td>
              <td>연질 탄성체 및 유연 고분자 비교</td>
            </tr>
            <tr class="highlight">
              <td><strong>Type V</strong> <span class="badge-opt">★ 추천</span></td>
              <td>3.18 × 9.53 mm</td>
              <td>7.62 mm</td>
              <td><strong style="color:var(--accent);">42.64 MPa</strong></td>
              <td><strong style="color:var(--accent);">14분 59초</strong></td>
              <td><strong style="color:var(--accent);">1.8 g</strong></td>
              <td>1 ~ 5 mm/min</td>
              <td>★ <strong>최고 효율 (R&D 신속시험 / 80% 비용절감)</strong></td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <!-- Section 3: FDM 3D Printing & DIC Optical Analysis -->
  <section class="container">
    <div class="section-header">
      <span class="section-tag">// Advanced Engineering & Testing</span>
      <h2 class="section-title">3D 프린팅 최적 공정 & DIC 광학 변형률 분석</h2>
      <p class="section-subtitle">
        시편의 층간 결합력을 극대화하는 FDM 적층 조건과 비접촉 2차원 변형률 가시화 기술을 적용합니다.
      </p>
    </div>
    ...
    <div class="tech-box-grid">
      ...
      <div class="tech-box">
        <h4><i class="bi bi-printer-fill text-primary"></i> 3D 프린팅 공정 파라미터 최적화</h4>
        <p>
          인장 하중 방향(X축)과 0° 일치하는 <strong>100% Solid Lines 라스터 적층</strong>을 적용하여 층간 박리를 원천 차단하고 단일 부재 수준의 인장강도를 구현합니다.
        </p>
        <table class="spec-dim-table">
          <tr><th>노즐 압출 온도</th><td>215 °C (층간 융착 강화)</td></tr>
          <tr><th>히팅베드 온도</th><td>80 °C (수축/들뜸 방지)</td></tr>
          <tr><th>적층 두께 (Layer Height)</th><td>0.25 mm (정밀 조도)</td></tr>
          <tr><th>인필 밀도 & 각도</th><td>100% Solid (0° 인장방향)</td></tr>
          <tr><th>출력 속도 & 브림</th><td>30 mm/s, 10 Lines Brim</td></tr>
        </table>
      </div>

      <!-- DIC Optical Analysis -->
      <div class="tech-box">
        <h4><i class="bi bi-camera-fill text-accent"></i> DIC 광학 변형률 분석 (Ncorr)</h4>
        <p>
          시편 표면에 백색 무광 코팅 및 <strong>2~4 pixel 고대비 랜덤 스펙클 패턴</strong>을 도포하여 UTM 인장 시험 중 발생하는 횡방향 수축(Exx) 및 축방향 연신(Eyy)을 비접촉 실시간 정밀 추적합니다.
        </p>
        <table class="spec-dim-table">
          <tr><th>분석 플랫폼</th><td>Ncorr 2D DIC + MATLAB</td></tr>
          <tr><th>서브셋 반경 & 간격</th><td>Subset Radius 23, Spacing 2</td></tr>
          <tr><th>스펙클 패턴 크기</th><td>2 ~ 4 Pixel 고밀도 분포</td></tr>
          <tr><th>측정 출력값</th><td>Exx(횡방향), Eyy(축방향), Necking</td></tr>
          <tr><th>카메라 세팅</th><td>50MP 고해상도 + 듀얼 조명 동기화</td></tr>
        </table>
      </div>

      <!-- Silicone & Construction Specimens -->
      <div class="tech-box" style="grid-column: 1 / -1;">
        <h4><i class="bi bi-building-fill-gear text-primary"></i> 건축용 구조 실리콘 & 실란트 공학 시편 라인업</h4>
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(240px, 1fr)); gap:1.2rem; margin-top:1.2rem;">
          <div style="background:var(--gray-50); padding:1.2rem; border-radius:8px; border:1px solid var(--gray-200);">
            <div style="font-weight:800; color:var(--dark); margin-bottom:0.3rem;">ASTM C1401 / C1135</div>
            <div style="font-size:0.82rem; color:var(--accent); font-weight:700; margin-bottom:0.5rem;">H-Block 구조 글레이징 접착 시편</div>
            <div style="font-size:0.82rem; color:var(--gray-600);">50×12×12mm 알루미늄/유리 구조용 실리콘(Dow 983) 인장접착강도 및 응집파괴 평가</div>
          </div>
          <div style="background:var(--gray-50); padding:1.2rem; border-radius:8px; border:1px solid var(--gray-200);">
            <div style="font-weight:800; color:var(--dark); margin-bottom:0.3rem;">ASTM D412 (Die C)</div>
            <div style="font-size:0.82rem; color:var(--accent); font-weight:700; margin-bottom:0.5rem;">엘라스토머 덤벨 인장·연신율 시편</div>
            <div style="font-size:0.82rem; color:var(--gray-600);">실리콘 고무 100% 모듈러스, 파단 인장강도 및 최대 연신율(400~800%) 시험</div>
          </div>
          <div style="background:var(--gray-50); padding:1.2rem; border-radius:8px; border:1px solid var(--gray-200);">
            <div style="font-weight:800; color:var(--dark); margin-bottom:0.3rem;">ASTM C719 (Class 50/25)</div>
            <div style="font-size:0.82rem; color:var(--accent); font-weight:700; margin-bottom:0.5rem;">사이클릭 열팽창 신축 시험체</div>
            <div style="font-size:0.82rem; color:var(--gray-600);">-26℃ ~ 70℃ 극한 환경 챔버에서 ±50% 주기적 압축/인장 반복 피로 내구성 검증</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="estimator" class="container">
    <div class="estimator-card">
      <div class="section-header" style="margin-bottom:2rem; text-align:left;">
        <span class="section-tag" style="color:#F97316;">// Real-time Specimen Estimator</span>
      ...
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <ul class="footer-links-list">
            ...
            <li><a href="/projects/kct/specimens#standards-grid">5대 규격 치수표</a></li>
  ...
  <script>
    const SPEC_DATA = {
      'TYPE-1': { name: 'ASTM D638 Type I', timePerUnitMin: 78.5, weightPerUnitG: 9.8, uts: '43.18 MPa', speed: '5 mm/min', ext: '25~50 mm 게이지' },
      ...
      'SIL-HBLOCK': { name: 'ASTM C1401 H-Block', timePerUnitMin: 45.0, weightPerUnitG: 35.0, uts: '1.0~1.5 MPa (접착)', speed: '12.5 mm/min', ext: '변위 센서' },
      'SIL-D412': { name: 'ASTM D412 Die C', timePerUnitMin: 20.0, weightPerUnitG: 12.0, uts: '2.5~3.5 MPa', speed: '500 mm/min', ext: '고신율 비디오 게이지' }
    };
