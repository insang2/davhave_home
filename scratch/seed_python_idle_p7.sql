-- Full Python IDLE PDF Lessons Part 7
...
INSERT INTO posts (
  ...
  '단위 테스트와 pytest를 학습합니다.',
  '<p>단위 테스트와 pytest를 학습합니다.</p>
',
  'published',
  '파이썬 테스트 코드 - pytest 사용법, unittest, fixture, mock 가짜 객체',
  '단위 테스트, pytest 프레임워크, mock 객체 활용법을 배웁니다.',
  25,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
...
INSERT INTO posts (
  ...
  '머신러닝과 Scikit-learn을 다룹니다.',
  '<p>머신러닝과 Scikit-learn을 다룹니다.</p>
',
  'published',
  '파이썬 머신러닝 - Scikit-learn, 선형 회귀, 결정 트리, Dataset 분할 & 평가',
  'Scikit-learn, 지도학습, train_test_split을 배웁니다.',
  26,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
...
INSERT INTO posts (
  ...
  'PyTorch 기반 딥러닝을 배웁니다.',
  '<p>PyTorch 기반 딥러닝을 배웁니다.</p>
',
  'published',
...
',
  ...
  'PySpark, RDD, Spark DataFrame 분산 연산을 다룹니다.',
  28,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
