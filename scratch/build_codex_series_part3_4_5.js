...
console.log('=== Codex로 일하는 법 [3편, 4편, 5편] 대용량 보강 2차 스크립트 작성 ===');

// ==========================================
// 3편 (Part 3: 문맥 엔지니어링, 자가 디버깅 & TDD)
// ==========================================
const part3Md = `
...
// ==========================================
// 4편 (Part 4: 멀티모달 UI, Figma 연동 & Visual Verification)
// ==========================================
const part4Md = `
...
// ==========================================
// 5편 (Part 5: ChatGPT App, SwiftUI & 브라우저 게임)
// ==========================================
const part5Md = `
...
// ==========================================
// JSON / SQL Generation for Part 3, 4 & 5
// ==========================================
const lesson27 = {
  order_index: 27,
  slug: 'ch27-working-with-codex-part3-context-engineering-and-tdd',
  title: '27. Codex로 일하는 법 [3편: 문맥 엔지니어링, 자가 디버깅 & TDD]',
  seo_title: 'Codex로 일하는 법 3편 - 문맥 엔지니어링, 최소 타격 버그 수정 및 TDD',
  seo_description: '문맥 절삭 및 프루닝 기술, 최소 타격 버그 수정, AI 주도 TDD 릴레이, 안전한 리팩터링 및 대형 저장소 탐색을 배웁니다.',
  excerpt: '문맥 절삭 및 프루닝 기술, 최소 타격 버그 수정, AI 주도 TDD 릴레이, 안전한 리팩터링 및 마이그레이션 가이드입니다.',
  body_md: part3Md
};

const lesson28 = {
  order_index: 28,
  slug: 'ch28-working-with-codex-part4-multimodal-ui-and-figma',
  title: '28. Codex로 일하는 법 [4편: 멀티모달 UI, Figma 연동 & Visual Verification]',
  seo_title: 'Codex로 일하는 법 4편 - 스크린샷 변환, Visual Verification & Figma 동기화',
  seo_description: '스크린샷을 코드 변환하는 Image-to-Code 프롬프트, 시각적 검증(Visual Verification), Figma 토큰 MCP 동기화 및 StudyFlow E2E 구축을 배웁니다.',
  excerpt: '스크린샷을 코드 변환하는 Image-to-Code, Visual Verification 루프, Figma 디자인 토큰 동기화 및 StudyFlow E2E 사례 가이드입니다.',
  body_md: part4Md
};

const lesson29 = {
  order_index: 29,
  slug: 'ch29-working-with-codex-part5-chatgpt-app-swiftui-and-games',
  title: '29. Codex로 일하는 법 [5편: ChatGPT App, SwiftUI & 브라우저 게임]',
  seo_title: 'Codex로 일하는 법 5편 - ChatGPT 대화형 앱, SwiftUI iOS 앱 & 멀티모달 게임',
  seo_description: 'ChatGPT App 도구 계약과 발견 가능성, 30분 SwiftUI iOS 앱 뼈대 구축, 브라우저 Canvas/WebGL 멀티모달 게임 제작법을 배웁니다.',
  excerpt: 'ChatGPT Canvas App 도구 메타데이터, 30분 SwiftUI iOS 앱 구축 루프, HTML5 Canvas/WebGL 미니게임 멀티모달 제작 가이드입니다.',
  body_md: part5Md
};
...
INSERT INTO posts (
  ...
  'education', 'ai', '${escapeSql(lesson27.slug)}', '${escapeSql(lesson27.title)}', '${escapeSql(lesson27.excerpt)}', '${escapeSql(part3Md)}', '${escapeSql(marked.parse(part3Md))}', 'published', '${escapeSql(lesson27.seo_title)}', '${escapeSql(lesson27.seo_description)}', ${lesson27.order_index}, '2026-08-03 00:00:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
INSERT INTO posts (
  ...
  'education', 'ai', '${escapeSql(lesson28.slug)}', '${escapeSql(lesson28.title)}', '${escapeSql(lesson28.excerpt)}', '${escapeSql(part4Md)}', '${escapeSql(marked.parse(part4Md))}', 'published', '${escapeSql(lesson28.seo_title)}', '${escapeSql(lesson28.seo_description)}', ${lesson28.order_index}, '2026-08-03 00:00:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
) ON CONFLICT(slug) DO UPDATE SET title = EXCLUDED.title, excerpt = EXCLUDED.excerpt, content_md = EXCLUDED.content_md, content_html = EXCLUDED.content_html, status = EXCLUDED.status, seo_title = EXCLUDED.seo_title, seo_description = EXCLUDED.seo_description, order_index = EXCLUDED.order_index, updated_at = CURRENT_TIMESTAMP;
...
INSERT INTO posts (
  ...
  'education', 'ai', '${escapeSql(lesson29.slug)}', '${escapeSql(lesson29.title)}', '${escapeSql(lesson29.excerpt)}', '${escapeSql(part5Md)}', '${escapeSql(marked.parse(part5Md))}', 'published', '${escapeSql(lesson29.seo_title)}', '${escapeSql(lesson29.seo_description)}', ${lesson29.order_index}, '2026-08-03 00:00:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
) ON CONFLICT(slug) DO UPDATE SET title = EXCLUDED.title, excerpt = EXCLUDED.excerpt, content_md = EXCLUDED.content_md, content_html = EXCLUDED.content_html, status = EXCLUDED.status, seo_title = EXCLUDED.seo_title, seo_description = EXCLUDED.seo_description, order_index = EXCLUDED.order_index, updated_at = CURRENT_TIMESTAMP;
`;

fs.writeFileSync('scratch/seed_codex_series_part3_4_5.sql', sqlContent, 'utf-8');
console.log('Successfully generated scratch/seed_codex_series_part3_4_5.sql with 2nd ENHANCED LENGTH!');
