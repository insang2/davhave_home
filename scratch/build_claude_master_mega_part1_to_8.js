...
console.log('=== Claude 마스터 가이드 1편~8편 초보자용 초정밀 메가 확장 스크립트 ===');

// ==========================================
// 1편 (Part 1: 생태계와 Software 3.0)
// ==========================================
const part1Md = `
...
fs.writeFileSync('scratch/seed_claude_master_mega_part1_to_8.sql', sqlContent, 'utf-8');
console.log('Successfully generated scratch/seed_claude_master_mega_part1_to_8.sql!');
