-- Full Python IDLE PDF Lessons Part 6
...
INSERT INTO posts (
  ...
  'Django와 FastAPI 아키텍처를 비교합니다.',
  '<p>Django와 FastAPI 아키텍처를 비교합니다.</p>
',
  'published',
...
INSERT INTO posts (
  ...
  'SQLAlchemy ORM 및 SQLModel 기반 데이터베이스 관리를 배웁니다.',
...
',
  ...
  'SQLAlchemy 2.0 모델링, Session DB CRUD를 다룹니다.',
  23,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
...
',
  ...
  'Selenium WebDriver와 Playwright 브라우저 자동화를 배웁니다.',
  24,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
