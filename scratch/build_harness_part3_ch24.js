...
console.log('=== 하네스 엔지니어링 완전 정복 [3부: 차세대 에이전트 오케스트레이션 & 130개 공식 소스 맵] 스크립트 작성 ===');
...
const lesson24 = {
  order_index: 24,
  slug: 'ch24-harness-engineering-part3-advanced-frameworks-and-cheatsheet',
  title: '24. 하네스 엔지니어링 완전 정복 [3부: 차세대 에이전트 오케스트레이션 & 130개 공식 소스 맵]',
  seo_title: '하네스 엔지니어링 3부 - 차세대 오케스트레이션, 용어집 및 130+ 공식 소스 맵',
  seo_description: 'Anthropic 3-에이전트(Planner-Generator-Evaluator), Arize 텔레메트리 자기개선, Stripe Minions, 실전 체크리스트, 에이전틱 용어집 및 130개 이상 카테고리별 소스 맵을 완벽 해설합니다.',
  excerpt: 'Anthropic 3-에이전트 오케스트레이션, Arize 텔레메트리 자기개선, Stripe Minions, 7대 체크리스트, 전문 용어집 및 130개 이상 공식 출처 맵을 포함한 완결편입니다.',
  body_md: part3Md
};
...
INSERT INTO posts (
  ...
  'education',
  'ai',
  '${escapeSql(lesson24.slug)}',
  '${escapeSql(lesson24.title)}',
  '${escapeSql(lesson24.excerpt)}',
  '${escapeSql(part3Md)}',
  '${escapeSql(marked.parse(part3Md))}',
  'published',
  '${escapeSql(lesson24.seo_title)}',
  '${escapeSql(lesson24.seo_description)}',
  ${lesson24.order_index},
  '2026-08-03 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
...
fs.writeFileSync('scratch/seed_harness_part3_ch24.sql', sqlContent, 'utf-8');
console.log('Successfully generated scratch/seed_harness_part3_ch24.sql!');
