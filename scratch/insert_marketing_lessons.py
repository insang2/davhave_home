...
all_lessons = lessons_1to10 + lessons_11to20

sql_file_path = os.path.join(os.path.dirname(__file__), "marketing_lessons.sql")

with open(sql_file_path, "w", encoding="utf-8") as f:
    f.write("-- Insert 20 Digital Marketing lessons into D1 Database\n")
...
print(f"SQL file generated at {sql_file_path} with {len(all_lessons)} lessons.")
