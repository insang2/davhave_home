...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Quick Jump Subnav */
    .subnav-bar { background: var(--white); border-bottom: 1px solid var(--gray-200); position: sticky; top: 72px; z-index: 990; overflow-x: auto; }
    .subnav-inner { display: flex; gap: 0.5rem; padding: 0.65rem 0; min-width: max-content; }
    .subnav-btn { font-size: 0.82rem; font-weight: 700; color: var(--gray-600); padding: 0.4rem 0.9rem; border-radius: 100px; background: var(--gray-100); transition: all 0.2s; display: inline-flex; align-items: center; gap: 0.35rem; }
    .subnav-btn:hover { background: var(--primary); color: var(--white); }
    ...
    .prop-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(340px, 1fr)); gap: 1.5rem; margin: 2rem 0; }
    .prop-card {
      background: var(--white);
      border: 1px solid var(--gray-200);
    ...
    .prop-card:hover { transform: translateY(-4px); box-shadow: var(--shadow); border-color: var(--primary-light); }
    .prop-badge { font-family: var(--mono); font-size: 0.75rem; font-weight: 800; padding: 0.25rem 0.6rem; border-radius: 4px; background: rgba(30,58,138,0.08); color: var(--primary); display: inline-block; margin-bottom: 0.75rem; }
    .prop-title { font-size: 1.15rem; font-weight: 800; color: var(--dark); margin-bottom: 0.4rem; }
    .prop-desc { font-size: 0.88rem; color: var(--gray-600); line-height: 1.65; margin-bottom: 1rem; flex: 1; }
    ...
    .math-sym { font-size: 1.2rem; font-weight: 800; color: #60A5FA; }
    .math-frac {
      display: inline-flex;
      flex-direction: column;
    ...
    .math-unit { font-size: 0.85rem; color: #94A3B8; font-weight: 500; margin-left: 0.4rem; }
    .formula-desc { font-size: 0.82rem; color: #94A3B8; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 0.5rem; margin-top: 0.3rem; }
    ...
    .faq-accordion-group { display: flex; flex-direction: column; gap: 1.1rem; max-width: 1050px; margin: 0 auto; }
    .faq-item {
      background: var(--white);
      border: 1px solid var(--gray-200);
      border-radius: var(--radius);
    ...
    .faq-item[open] { border-color: var(--primary); background: #FFFFFF; }
    .faq-item summary {
      padding: 1.3rem 1.6rem;
      font-size: 1.05rem;
      font-weight: 700;
    ...
    .faq-item[open] summary { background: rgba(30,58,138,0.04); color: var(--primary); font-weight: 800; border-bottom: 1px solid var(--gray-200); }
    .faq-icon-arrow { font-size: 1.1rem; color: var(--gray-400); transition: transform 0.25s ease; }
    .faq-item[open] .faq-icon-arrow { transform: rotate(180deg); color: var(--primary); }
    .faq-answer {
    ...
    .faq-tag { font-family: var(--mono); font-size: 0.72rem; font-weight: 800; padding: 0.2rem 0.5rem; border-radius: 4px; background: rgba(30,58,138,0.08); color: var(--primary); margin-right: 0.6rem; }
...
<body>
  ...
  <section class="container" id="faq">
    <div class="section-header">
      <span class="section-tag">// Expert Technical FAQ</span>
      <h2 class="section-title">ASTM D638 플라스틱 인장 시험 전문 기술 FAQ</h2>
      <p class="section-subtitle">
        ISO 등가 표준 비교, 신장계 등급 규격, 공칭 변형률 적용 원리 및 현장 시험 오류 완화 방안에 대한 12대 핵심 질의응답입니다.
      </p>
    </div>
    ...
    <div class="faq-accordion-group">
      ...
      <details class="faq-item" open>
        <summary>
          <span><span class="faq-tag">표준 비교</span> ASTM D638의 ISO 등가 표준은 무엇입니까?</span>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">ISO 527 비교</span> ASTM D638 결과와 ISO 527-2 결과는 어떻게 비교되며, 어떤 차이점을 알아야 합니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">변형률 이론</span> 항복 후 연신율에 공칭 변형률이 필요한 이유는 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">계측 등급</span> ASTM D638에 필요한 신장계 등급은 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">환경 챔버</span> ASTM D638은 조절(노화)되거나 비상온 환경(예: 고온, 습도)에 노출된 플라스틱에 사용할 수 있습니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">오류 완화</span> ASTM D638 인장 시험을 수행할 때 흔히 발생하는 오류 또는 비준수 원인은 무엇이며, 이를 어떻게 완화할 수 있습니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">규격 관리</span> 현재 사용 중인 ASTM D638 버전은 무엇이며, 제 실험실이 최신 상태인지 어떻게 알 수 있습니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">규격 구분</span> ASTM D638 대신 ASTM D882를 언제 사용해야 합니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">고무/엘라스토머</span> ASTM D638과 D412의 차이점은 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">마이크로 시편</span> ASTM D638과 D1708의 차이점은 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">복합재 규격</span> ASTM D638과 D3039의 차이점은 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">총괄 개요</span> ASTM D638은 무엇을 측정합니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
