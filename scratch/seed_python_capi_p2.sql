-- Full Python C-API Lessons Part 2
...
INSERT INTO posts (
  ...
  '함수(Function) 선언과 LEGB 규칙을 다룹니다.',
  '<p>함수(Function) 선언과 LEGB 규칙을 다룹니다.</p>
',
  'published',
  '파이썬 함수와 람다 - def, *args, **kwargs, lambda, LEGB 스코프 룰',
  'def 함수 정의, 가변 인자(*args, **kwargs), 람다 함수, LEGB 스코프 변수 참조 규칙을 해설합니다.',
  5,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
...
INSERT INTO posts (
  ...
  '모듈(Module)과 가상환경(venv)을 다룹니다.',
  '<p>모듈(Module)과 가상환경(venv)을 다룹니다.</p>
',
  'published',
  '파이썬 모듈과 패키지 - import, __name__, sys.path, venv 가상환경 & pip',
  '모듈, 패키지, __name__ == "__main__", sys.path, venv 가상환경 및 pip 패키지 관리를 배웁니다.',
  6,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
...
INSERT INTO posts (
  ...
  '파일 입출력(File I/O)과 with 컨텍스트 매니저를 다룹니다.',
  '<p>파일 입출력(File I/O)과 with 컨텍스트 매니저를 다룹니다.</p>
',
  'published',
...
INSERT INTO posts (
  ...
  '예외 처리(Exception Handling)를 학습합니다.',
  '<p>예외 처리(Exception Handling)를 학습합니다.</p>
',
  'published',
