-- Full Python IDLE PDF Lessons Part 4
...
',
  ...
  '표준 GUI 라이브러리 tkinter, 컴포넌트, 레이아웃 매니저를 학습합니다.',
  13,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
...
INSERT INTO posts (
  ...
  'threading, multiprocessing 및 asyncio 코딩을 학습합니다.',
...
',
  ...
  'multiprocessing, threading, asyncio 비동기 프로그래밍을 배웁니다.',
  14,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
...
',
  ...
  'requests, BeautifulSoup4 DOM 파싱 및 CSS 셀렉터를 배웁니다.',
  15,
  '2026-08-02 00:00:00',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
...
INSERT INTO posts (
  ...
  '타입 힌팅과 typing 모듈, mypy 정적 분석기를 다룹니다.',
  '타입 힌팅을 다룹니다.',
  '<p>타입 힌팅을 다룹니다.</p>
',
  'published',
