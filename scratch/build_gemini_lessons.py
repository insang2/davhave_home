...
gemini_lessons = [
    {
        "order_index": 50,
        "slug": "gemini-15-pro-flash-api-overview-and-architecture",
        "title": "Gemini 1.5 Pro & Flash API 아키텍처 및 200만 토큰 멀티모달 가이드",
        "seo_title": "Google Gemini 1.5 Pro/Flash 아키텍처 & 200만 토큰 멀티모달",
        "excerpt": "Google의 차세대 LLM인 Gemini 1.5 Pro와 초고속 Flash 모델의 아키텍처, 200만 토큰 문맥 윈도우, 용어 사전 및 API 연동 기초를 배웁니다.",
        "content_md": """## Gemini 1.5 Pro & Flash 아키텍처의 특징
...
"""
    ...
    {
        "order_index": 51,
        "slug": "google-ai-studio-system-instructions-and-prompt-tuning",
        "title": "Google AI Studio 시스템 프롬프트 세팅 및 파라미터 최적화",
        "seo_title": "Google AI Studio 활용 가이드: System Instruction & 프롬프트 튜닝",
        "excerpt": "Google AI Studio 웹 콘솔을 활용해 System Instruction, Temperature, Top-K 파라미터를 최적화하고 프로토타입을 테스트하는 가이드입니다.",
        "content_md": """## Google AI Studio의 개념과 활용법
...
"""
    ...
    {
        "order_index": 52,
        "slug": "gemini-multimodal-pdf-image-audio-parsing",
        "title": "Gemini 멀티모달: 이미지, 오디오, 1,000페이지 PDF 대용량 문서 분석",
        "seo_title": "Gemini 멀티모달 분석: 이미지, 오디오 파일 & 대용량 PDF 파싱",
        "excerpt": "1,000페이지 분량의 수치 PDF 문서, 회의록 오디오 녹음본, 복잡한 설계도 이미지를 Gemini API로 원스톱 파싱하는 실전 가이드입니다.",
        "content_md": """## 네이티브 멀티모달(Native Multimodal) 파이프라인
...
"""
    },
    {
        ...
        "title": "Gemini Structured Output: JSON Schema 기반 구조화 데이터 100% 보장",
        "seo_title": "Gemini Structured Output: response_mime_type & JSON Schema 출력",
        "excerpt": "Gemini API의 `response_mime_type` 및 JSON Schema 파라미터를 활용해 파싱 오류 없이 100% 완벽한 JSON 규격을 반환받는 기술입니다.",
        "content_md": """## 구조화 데이터(Structured Output)의 의의
...
"""
    ...
    {
        "order_index": 54,
        "slug": "gemini-function-calling-and-tool-use-guide",
        "title": "Gemini Function Calling & 서드파티 API 커스텀 툴 융합 개발",
        "seo_title": "Gemini Function Calling & 외부 REST API 툴 연동 실전 가이드",
        "excerpt": "Gemini 모델이 직접 실시간 날씨, 데이터베이스 쿼리, 사내 REST API 함수를 호출하여 답변을 완성하는 Function Calling 튜토리얼입니다.",
        "content_md": """## Function Calling(함수 호출)의 동작 원리
...
"""
    ...
    {
        "order_index": 55,
        "slug": "firebase-ai-logic-gemini-web-integration",
        "title": "Firebase AI Logic (Gemini API) 웹/모바일 앱 네이티브 통합 튜토리얼",
        "seo_title": "Firebase Vertex AI / Gemini API 웹 & Flutter 네이티브 연동",
        "excerpt": "Firebase Vertex AI SDK(Firebase AI Logic)를 활용해 웹 브라우저 및 모바일 앱에서 백엔드 없이 안전하게 Gemini API를 연동하는 가이드입니다.",
        "content_md": """## Firebase AI Logic (Vertex AI for Firebase) 소개
...
"""
    ...
    {
        "order_index": 56,
        "slug": "gemini-context-caching-cost-reduction-strategies",
        "title": "Context Caching 기술로 Gemini API 프롬프트 호스팅 비용 90% 절감",
        "seo_title": "Gemini Context Caching: 프롬프트 비용 90% 절감 & 속도 향상 전략",
        "excerpt": "대용량 코드베이스나 매뉴얼 PDF를 캐싱하여 repeated input 토큰 비용을 최대 90% 아끼는 Gemini Context Caching 활용법입니다.",
        "content_md": """## Context Caching이란 무엇인가?
...
"""
    ...
    {
        "order_index": 57,
        "slug": "gemini-python-sdk-realtime-streaming-agent",
        "title": "Python SDK 및 실시간 스트리밍 에이전트 구축 실전",
        "seo_title": "Gemini Python SDK & 실시간 스트리밍(Streaming) 챗봇 에이전트",
        "excerpt": "Python `google-generativeai` SDK를 사용해 답안이 출력되는 즉시 타자기 효과로 실시간 응답을 스트리밍하는 자율형 챗봇 구축 튜토리얼입니다.",
        "content_md": """## 스트리밍(Streaming) 답변의 필연성
...
"""
    ...
    {
        "order_index": 58,
        "slug": "gemini-vertex-ai-enterprise-security-governance",
        "title": "Vertex AI 전환과 엔터프라이즈 데이터 보안 & 쿼터 관리",
        "seo_title": "Gemini Vertex AI 엔터프라이즈 보안 & Google Cloud 쿼터 관리",
        "excerpt": "Google AI Studio에서 기업용 Vertex AI 플랫폼으로 마이그레이션하고 SOC2, HIPAA 데이터 보안 준수 및 쿼터(Quota) 관리를 구성하는 가이드입니다.",
        "content_md": """## Google AI Studio vs Vertex AI 차이점
...
"""
    ...
    {
        "order_index": 59,
        "slug": "gemini-developer-cheatsheet-and-master-roadmap",
        "title": "Gemini 에이전틱 개발자 종합 치트시트 & 마스터 로드맵",
        "seo_title": "Gemini 에이전틱 개발자 치트시트 & 2026 마스터 로드맵",
        "excerpt": "Gemini 1.5 Pro/Flash 파이프라인 구축부터 치트시트, 멀티모달, Function Calling, 요금 최적화까지 종합 정리한 완결 가이드입니다.",
        "content_md": """## Gemini 에이전틱 개발 마스터 로드맵
...
# Write SQL to insert 10 Gemini lessons into D1
import re
...
sql_file = os.path.join(os.path.dirname(__file__), "insert_gemini_lessons.sql")
with open(sql_file, "w", encoding="utf-8") as f:
    f.write("-- Insert 10 Gemini lessons into D1 database for category = 'ai'\n")
    for item in gemini_lessons:
        title = item["title"].replace("'", "''")
        seo_title = item["seo_title"].replace("'", "''")
        excerpt = item["excerpt"].replace("'", "''")
        content_md = item["content_md"].replace("'", "''")
        content_html = md_to_html(item["content_md"]).replace("'", "''")
        slug = item["slug"]
...
print(f"Generated Gemini SQL file at {sql_file} with {len(gemini_lessons)} items.")
