...
# 21 ~ 30 디지털 마케팅, SEO, 백링크, 퍼포먼스 광고 심화 레슨 10편 생성
lessons_21to30 = [
    {
        "order_index": 21,
        ...
        "excerpt": "검색엔진 상위 노출의 핵심인 고품질 백링크(Backlink)를 획득하는 5가지 전략과 스팸 백링크 차단 기법을 상세히 배웁니다.",
...
print(f"21~30번 마케팅 레슨 {len(lessons_21to30)}개 생성 준비 완료")
