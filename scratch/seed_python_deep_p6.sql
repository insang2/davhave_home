-- Full Python Stdlib Deep Lessons Part 6
...
INSERT INTO posts (
  ...
  'NumPy 배열 연산과 Pandas 데이터프레임(DataFrame) 전처리 기술을 다룹니다.',
  '<p>NumPy 배열 연산과 Pandas 데이터프레임(DataFrame) 전처리 기술을 다룹니다.</p>
',
  'published',
...
INSERT INTO posts (
  ...
  'Django 풀스택 프레임워크와 비동기 FastAPI 아키텍처를 비교합니다.',
  '<p>Django 풀스택 프레임워크와 비동기 FastAPI 아키텍처를 비교합니다.</p>
',
  'published',
...
INSERT INTO posts (
  ...
  '웹 자동화 도구인 Selenium과 Playwright를 배웁니다.',
  '<p>웹 자동화 도구인 Selenium과 Playwright를 배웁니다.</p>
',
  'published',
