...
console.log('=== Claude 마스터 가이드 9편~15편 초보자용 초정밀 메가 확장 스크립트 ===');
...
fs.writeFileSync('scratch/seed_claude_master_mega_part9_to_15.sql', sqlContent, 'utf-8');
console.log('Successfully generated scratch/seed_claude_master_mega_part9_to_15.sql with FIXED ESCAPES!');
