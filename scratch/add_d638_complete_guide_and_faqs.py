...
print("=== Adding ASTM D638 Complete Key Properties, Specimen Geometry & 12 Comprehensive FAQs ===")

with open("scratch/specimens_template.html", "r", encoding="utf-8") as f:
    html = f.read()

# 1. Update Head with FAQPage JSON-LD Schema
faq_jsonld = {
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ASTM D638의 대표적인 ISO 등가 표준은 ISO 527-1(일반 원칙) 및 ISO 527-2(성형 및 압출 플라스틱 시험 조건)입니다. 두 규격 모두 플라스틱의 인장 물성을 평가하지만 시편 형상, 치수 및 탄성계수 측정 속도 제어에서 차이가 있습니다."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ASTM D638 Type I 시편(전장 165mm, 폭 13mm, 표점 50mm)과 ISO 527-2 Type 1A/1B 시편(전장 170mm, 폭 10mm, 표점 75mm 또는 50mm)은 치수가 다릅니다. 또한 ISO 527은 탄성계수 측정 시 1mm/min 후 본 시험 시 속도를 자동 전환하는 2단계 속도 제어를 요구하는 반면 ASTM D638은 단일 속도(통상 5mm/min)를 유지합니다."
      }
    },
    {
      "@type": "Question",
...
if 'application/ld+json' not in html:
    html = html.replace('</head>', faq_schema_tag + '</head>')

# 2. Add Accordion CSS for FAQ
faq_css = """
    /* FAQ Accordion Styles */
    .faq-section { margin-top: 4.5rem; }
    .faq-accordion-group { display: flex; flex-direction: column; gap: 1rem; max-width: 1050px; margin: 0 auto; }
    .faq-item {
...
if ".faq-accordion-group" not in html:
    html = html.replace("/* Math Formula Block Styles */", faq_css + "\n    /* Math Formula Block Styles */")

# 3. Create the FAQ HTML Section
faq_section_html = """
  <!-- Section: ASTM D638 Comprehensive FAQ 12 -->
  <section class="container faq-section" id="faq">
    ...
    <div class="faq-accordion-group">
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">변형률 이론</span> 항복 후 연신율에 공칭 변형률(Nominal Strain)이 필요한 이유는 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">계측 등급</span> ASTM D638에 필요한 신장계(신율계, Extensometer) 등급은 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">고무/엘라스토머</span> ASTM D638과 ASTM D412의 차이점은 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">마이크로 시편</span> ASTM D638과 ASTM D1708의 차이점은 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
      ...
      <details class="faq-item">
        <summary>
          <span><span class="faq-tag">복합재 규격</span> ASTM D638과 ASTM D3039의 차이점은 무엇입니까?</span>
          <i class="bi bi-chevron-down faq-icon-arrow"></i>
        </summary>
        <div class="faq-answer">
          <p>
...
# Place FAQ section right before the order form section
if 'id="faq"' not in html:
    html = html.replace('<!-- Section: Order Form -->', faq_section_html + '\n  <!-- Section: Order Form -->')

with open("scratch/specimens_template.html", "w", encoding="utf-8") as f:
    f.write(html)

print("Added FAQPage JSON-LD and 12 FAQ Accordions successfully!")
