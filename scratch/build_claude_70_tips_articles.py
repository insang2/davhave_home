...
print("Loaded pdf_extracted.txt:", len(pdf_raw_text), "bytes")
...
# 70가지 파워 팁 4개 완벽 레슨 생성
claude_70_tips_lessons = [
    {
        "order_index": 60,
        "slug": "claude-code-70-tips-part1-agentic-mindset-and-basics",
        "title": "Claude Code 70가지 파워 팁: 에이전틱 사고방식과 환경 설정 가이드",
        "seo_title": "Claude Code 70가지 파워 팁 1부: 에이전틱 사고방식 & 환경 설정",
        "excerpt": "Anthropic 해커톤 우승자 ykdojo와 DevRel Ado Kukic이 정리한 Claude Code 70가지 실전 팁 중 에이전틱 사고방식, 계획 모드 vs 욜로 모드, CLAUDE.md 및 커스텀 상태 라인 설정법을 배웁니다.",
        "content_md": """## Claude Code 완전 가이드: 해커톤 우승자의 70가지 파워 팁
...
"""
    ...
    {
        "order_index": 61,
        "slug": "claude-code-70-tips-part2-productivity-and-context-mastery",
        "title": "Claude Code 70가지 파워 팁: 생산성 극대화와 컨텍스트 지배 기술",
        "seo_title": "Claude Code 70가지 파워 팁 2부: 생산성 극대화 & 컨텍스트 지배",
        "excerpt": "Claude Code 실전 팁중 음성 코딩, 터미널 출력 추출, 선제적 컨텍스트 압축, `/context` X-Ray 기능 및 대화 복제 기술을 배웁니다.",
        "content_md": """## 1. 생산성을 극대화하는 핵심 기술 (Part 3)
...
"""
    ...
    {
        "order_index": 62,
        "slug": "claude-code-70-tips-part3-git-workflow-mcp-hooks-agents",
        "title": "Claude Code 70가지 파워 팁: Git Worktrees와 MCP·Hooks·Subagent 완전 정복",
        "seo_title": "Claude Code 70가지 파워 팁 3부: Git Worktrees & MCP, Hooks, Subagent",
        "excerpt": "Git Worktrees 병렬 브랜치 작업, 대화형 PR 리뷰, MCP 외부 도구 연동, Hooks 검증 규칙, 전문 서브에이전트 활용법을 정밀 수록합니다.",
        "content_md": """## 1. Git과 GitHub 워크플로우 완전 정복 (Part 5)
...
"""
    ...
    {
        "order_index": 63,
        "slug": "claude-code-70-tips-part4-automation-container-and-70-tips-cheatsheet",
        "title": "Claude Code 70가지 파워 팁: 자동화, CI/CD 통합 및 70가지 팁 완벽 치트시트",
        "seo_title": "Claude Code 70가지 파워 팁 4부: CI/CD 자동화 & 70가지 팁 총정리 치트시트",
        "excerpt": "Headless 모드 CI/CD 통합, Docker 컨테이너 샌드박스 격리, 브라우저 자동화 및 ykdojo/Ado의 70가지 팁 전체 마스터 치트시트 완결판입니다.",
        "content_md": """## 1. 시스템 최적화와 자동화 (Part 7~9)
...
# Write SQL to insert/update 4 Claude 70-Tips lessons into D1
sql_file = os.path.join(os.path.dirname(__file__), "insert_claude_70_tips.sql")
with open(sql_file, "w", encoding="utf-8") as f:
    f.write("-- Insert 4 Claude 70 Tips Master Lessons into D1 database\n")
    for item in claude_70_tips_lessons:
...
print(f"Generated Claude 70-Tips SQL file at {sql_file} with {len(claude_70_tips_lessons)} items.")
