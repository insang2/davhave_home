-- Full Python C-API Lessons Part 3
...
INSERT INTO posts (
  ...
  '객체지향 프로그래밍(OOP) 기초를 학습합니다.',
  '<p>객체지향 프로그래밍(OOP) 기초를 학습합니다.</p>
',
  'published',
...
INSERT INTO posts (
  ...
  '상속(Inheritance)과 매직 메소드(Dunder Methods)를 익힙니다.',
  '<p>상속(Inheritance)과 매직 메소드(Dunder Methods)를 익힙니다.</p>
',
  'published',
...
INSERT INTO posts (
  ...
  '제너레이터(Generator)와 데코레이터(Decorator)를 배웁니다.',
  '<p>제너레이터(Generator)와 데코레이터(Decorator)를 배웁니다.</p>
',
  'published',
